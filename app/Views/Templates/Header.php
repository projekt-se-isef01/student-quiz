...
<nav class="head navbar navbar-light bg-dark">
    <div class=" container-fluid  my-md-2">
        ...
        <div class="ml-xl-auto pl-5 fz">
            <?php if(isset($title))?>
            <?= $title ?>
        </div>
        <div class="row mx-2">
<div class="col">
            <a class="pl-5 btn btn bg-light" method="post" href="<?php echo base_url(); ?>/Login/logout" >Logout
            </a>
</div>
            <div class="col">
            ...
            <div class="col pr-lg-3"><?php if(!empty($_SESSION['name'])):?>
